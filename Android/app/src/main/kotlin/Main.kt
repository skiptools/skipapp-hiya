...
internal val logger: SkipLogger = SkipLogger(subsystem = "hiya.skip", category = "HiyaSkip")

private typealias AppRootView = HiyaSkipRootView
private typealias AppDelegate = HiyaSkipAppDelegate
